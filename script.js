...
function addToCart(name, price) {
    ...
    if(existingItem) {
        // Se o item já existe, aumenta apenas a sua quantidade (+1)
...
function updateCartModal() {
    ...
    // Quantidade de itens no carrinho (na barra vermelha ())
...
// Manipulando o endereço: caso o usuário não colocar o endereço, a borda ao redor ficará vermelha
